...
void serialCom(void)
{
    ...
    case 'a':                  // Loop Delta Times
        itoa(deltaTime1000Hz, numberString, 10);
        uartPrint(numberString);
        uartPrint(", ");
        itoa(deltaTime500Hz, numberString, 10);
        uartPrint(numberString);
        uartPrint(", ");
        itoa(deltaTime200Hz, numberString, 10);
        uartPrint(numberString);
        uartPrint(", ");
        itoa(deltaTime100Hz, numberString, 10);
        uartPrint(numberString);
        uartPrint(", ");
        itoa(deltaTime50Hz, numberString, 10);
        uartPrint(numberString);
        uartPrint(", ");
        itoa(deltaTime10Hz, numberString, 10);
        uartPrint(numberString);
        uartPrint(", ");
        itoa(deltaTime5Hz, numberString, 10);
        uartPrint(numberString);
        uartPrint(", ");
        itoa(deltaTime1Hz, numberString, 10);
        uartPrint(numberString);
        uartPrint("\n");
        break;
    ...
    case 'b':                  // Loop Execution Times
        itoa(executionTime500Hz, numberString, 10);
        uartPrint(numberString);
        uartPrint(", ");
        itoa(executionTime200Hz, numberString, 10);
        uartPrint(numberString);
        uartPrint(", ");
        itoa(executionTime100Hz, numberString, 10);
        uartPrint(numberString);
        uartPrint(", ");
        itoa(executionTime50Hz, numberString, 10);
        uartPrint(numberString);
        uartPrint(", ");
        itoa(executionTime10Hz, numberString, 10);
        uartPrint(numberString);
        uartPrint(", ");
        itoa(executionTime5Hz, numberString, 10);
        uartPrint(numberString);
        uartPrint(", ");
        itoa(executionTime1Hz, numberString, 10);
        uartPrint(numberString);
        uartPrint("\n");
        break;
    ...
    case 'e':                  // 200 Hz Accel Data
        ftoa(sensors.accel200Hz[ROLL], numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(sensors.accel200Hz[PITCH], numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(sensors.accel200Hz[YAW], numberString);
        uartPrint(numberString);
        uartPrint("\n");
        break;
    ...
    case 'f':                  // 100 Hz Accel Data
        ftoa(sensors.accel100Hz[ROLL], numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(sensors.accel100Hz[PITCH], numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(sensors.accel100Hz[YAW], numberString);
        uartPrint(numberString);
        uartPrint("\n");
        break;
    ...
    case 'g':                  // 200 Hz Gyro Data
        ftoa(sensors.gyro200Hz[ROLL], numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(sensors.gyro200Hz[PITCH], numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(sensors.gyro200Hz[YAW], numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(gyroTemperature, numberString);
        uartPrint(numberString);
        uartPrint("\n");
        break;
    ...
    case 'h':                  // 100 Hz Gyro Data
        ftoa(sensors.gyro100Hz[ROLL], numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(sensors.gyro100Hz[PITCH], numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(sensors.gyro100Hz[YAW], numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(gyroTemperature, numberString);
        uartPrint(numberString);
    ...
    case 'j':                  // 10 Hz Mag Data
        ftoa(sensors.mag10Hz[XAXIS], numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(sensors.mag10Hz[YAXIS], numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(sensors.mag10Hz[ZAXIS], numberString);
        uartPrint(numberString);
        uartPrint("\n");
        break;
    ...
    case 'l':                  // 10Hz Pressure Altitude
        ftoa(sensors.pressureAltitude10Hz, numberString);
        uartPrint(numberString);
        uartPrint("\n");
        break;
    ...
    case 'm':                  // Tilts (from 100 Hz Accel Data)
        ftoa(atan2(-sensors.accel100Hz[YAXIS], -sensors.accel100Hz[ZAXIS]) * 57.3f, numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(atan2(sensors.accel100Hz[XAXIS], -sensors.accel100Hz[ZAXIS]) * 57.3f, numberString);
        uartPrint(numberString);
        uartPrint("\n");
        break;
    ...
    case 'n':                  // 200 Hz Attitude Data
        ftoa(sensors.attitude200Hz[ROLL] * 57.3f, numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(sensors.attitude200Hz[PITCH] * 57.3f, numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(sensors.attitude200Hz[YAW] * 57.3f, numberString);
        uartPrint(numberString);
        uartPrint("\n");
        break;
    ...
    case 'q':                  // PWM Outputs
        itoa(TIM1->CCR1, numberString, 10);
        uartPrint(numberString);
        uartPrint(", ");
        itoa(TIM1->CCR4, numberString, 10);
        uartPrint(numberString);
        uartPrint(", ");
        itoa(TIM4->CCR1, numberString, 10);
        uartPrint(numberString);
        uartPrint(", ");
        itoa(TIM4->CCR2, numberString, 10);
        uartPrint(numberString);
        uartPrint(", ");
        itoa(TIM4->CCR3, numberString, 10);
        uartPrint(numberString);
        uartPrint(", ");
        itoa(TIM4->CCR4, numberString, 10);
        uartPrint(numberString);
        uartPrint("\n");
        break;
    ...
    case 'r':                  // Rate PIDs
        ...
        ftoa(systemConfig.PID[ROLL_RATE_PID].P, numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(systemConfig.PID[ROLL_RATE_PID].I, numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(systemConfig.PID[ROLL_RATE_PID].D, numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(systemConfig.PID[ROLL_RATE_PID].windupGuard, numberString);
        uartPrint(numberString);
        uartPrint(", ");
        itoa(systemConfig.PID[ROLL_RATE_PID].type, numberString, 10);
        uartPrint(numberString);
        uartPrint("\n");

        uartPrint("Pitch Rate PID: ");
        ftoa(systemConfig.PID[PITCH_RATE_PID].P, numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(systemConfig.PID[PITCH_RATE_PID].I, numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(systemConfig.PID[PITCH_RATE_PID].D, numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(systemConfig.PID[PITCH_RATE_PID].windupGuard, numberString);
        uartPrint(numberString);
        uartPrint(", ");
        itoa(systemConfig.PID[PITCH_RATE_PID].type, numberString, 10);
        uartPrint(numberString);
        uartPrint("\n");

        uartPrint("Yaw Rate PID:   ");
        ftoa(systemConfig.PID[YAW_RATE_PID].P, numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(systemConfig.PID[YAW_RATE_PID].I, numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(systemConfig.PID[YAW_RATE_PID].D, numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(systemConfig.PID[YAW_RATE_PID].windupGuard, numberString);
        uartPrint(numberString);
        uartPrint(", ");
        itoa(systemConfig.PID[YAW_RATE_PID].type, numberString, 10);
        uartPrint(numberString);
        uartPrint("\n");
    ...
    case 's':                  // Attitude PIDs
        ...
        ftoa(systemConfig.PID[ROLL_ATT_PID].P, numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(systemConfig.PID[ROLL_ATT_PID].I, numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(systemConfig.PID[ROLL_ATT_PID].D, numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(systemConfig.PID[ROLL_ATT_PID].windupGuard, numberString);
        uartPrint(numberString);
        uartPrint(", ");
        itoa(systemConfig.PID[ROLL_ATT_PID].type, numberString, 10);
        uartPrint(numberString);
        uartPrint("\n");

        uartPrint("Pitch Attitude PID: ");
        ftoa(systemConfig.PID[PITCH_ATT_PID].P, numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(systemConfig.PID[PITCH_ATT_PID].I, numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(systemConfig.PID[PITCH_ATT_PID].D, numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(systemConfig.PID[PITCH_ATT_PID].windupGuard, numberString);
        uartPrint(numberString);
        uartPrint(", ");
        itoa(systemConfig.PID[PITCH_ATT_PID].type, numberString, 10);
        uartPrint(numberString);
        uartPrint("\n");

        uartPrint("Heading PID:        ");
        ftoa(systemConfig.PID[HEADING_PID].P, numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(systemConfig.PID[HEADING_PID].I, numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(systemConfig.PID[HEADING_PID].D, numberString);
        uartPrint(numberString);
        uartPrint(", ");
        ftoa(systemConfig.PID[HEADING_PID].windupGuard, numberString);
        uartPrint(numberString);
        uartPrint(", ");
        itoa(systemConfig.PID[HEADING_PID].type, numberString, 10);
        uartPrint(numberString);
        uartPrint("\n");
    ...
    case 't':                  // Sensor Calibration Data
        ...
        ftoa(sensorConfig.accelCutoff, numberString);
        uartPrint(numberString);
        uartPrint("\n");

#if defined(USE_MADGWICK_AHRS)
        uartPrint("Beta:                      ");
        ftoa(sensorConfig.beta, numberString);
        uartPrint(numberString);
        uartPrint("\n");
#endif
        ...
        uartPrint("KpAcc:                     ");
        ftoa(sensorConfig.KpAcc, numberString);
        uartPrint(numberString);
        uartPrint("\n");

        uartPrint("KiAcc:                     ");
        ftoa(sensorConfig.KiAcc, numberString);
        uartPrint(numberString);
        uartPrint("\n");

        uartPrint("KpMag:                     ");
        ftoa(sensorConfig.KpMag, numberString);
        uartPrint(numberString);
        uartPrint("\n");

        uartPrint("KiMag:                     ");
        ftoa(sensorConfig.KiMag, numberString);
        uartPrint(numberString);
        uartPrint("\n");
#endif
        ...
        ftoa(sensorConfig.accelVariance, numberString);
        uartPrint(numberString);
        uartPrint("\n");

        uartPrint("Mag Variance:              ");
        ftoa(sensorConfig.magVariance, numberString);
        uartPrint(numberString);
        uartPrint("\n");

        uartPrint("Process Variance:          ");
        ftoa(sensorConfig.processVariance, numberString);
        uartPrint(numberString);
        uartPrint("\n");
    ...
    case 'u':                  // System Configuration Data
        ...
        itoa(numberMotor, numberString, 10);
        uartPrint(numberString);
        uartPrint("\n");

        uartPrint("ESC PWM Rate:                   ");
        itoa((uint16_t) systemConfig.escPwmRate, numberString, 10);
        uartPrint(numberString);
        uartPrint("\n");

        uartPrint("Servo PWM Rate:                 ");
        itoa((uint16_t) systemConfig.servoPwmRate, numberString, 10);
        uartPrint(numberString);
        uartPrint("\n");

        uartPrint("Mid Command:                    ");
        itoa((uint16_t) systemConfig.midCommand, numberString, 10);
        uartPrint(numberString);
        uartPrint("\n");

        uartPrint("Min Check:                      ");
        itoa((uint16_t) systemConfig.minCheck, numberString, 10);
        uartPrint(numberString);
        uartPrint("\n");

        uartPrint("Max Check:                      ");
        itoa((uint16_t) systemConfig.maxCheck, numberString, 10);
        uartPrint(numberString);
        uartPrint("\n");

        uartPrint("Min Throttle:                   ");
        itoa((uint16_t) systemConfig.minThrottle, numberString, 10);
        uartPrint(numberString);
        uartPrint("\n");

        uartPrint("Max Thottle:                    ");
        itoa((uint16_t) systemConfig.maxThrottle, numberString, 10);
        uartPrint(numberString);
        uartPrint("\n");

        if (systemConfig.mixerConfiguration == MULTITYPE_GIMBAL) {
            uartPrint("Gimbal Roll Servo Min:          ");
            itoa((uint16_t) systemConfig.gimbalRollServoMin, numberString, 10);
            uartPrint(numberString);
            uartPrint("\n");
            uartPrint("Gimbal Roll Servo Mid:          ");
            itoa((uint16_t) systemConfig.gimbalRollServoMid, numberString, 10);
            uartPrint(numberString);
            uartPrint("\n");
            uartPrint("Gimbal Roll Servo Max:          ");
            itoa((uint16_t) systemConfig.gimbalRollServoMax, numberString, 10);
            uartPrint(numberString);
            uartPrint("\n");
            uartPrint("Gimbal Roll Servo Gain:         ");
            ftoa(systemConfig.gimbalRollServoGain, numberString);
            uartPrint(numberString);
            uartPrint("\n");
            uartPrint("Gimbal Pitch Servo Min:         ");
            itoa((uint16_t) systemConfig.gimbalPitchServoMin, numberString, 10);
            uartPrint(numberString);
            uartPrint("\n");
            uartPrint("Gimbal Pitch Servo Mid:         ");
            itoa((uint16_t) systemConfig.gimbalPitchServoMid, numberString, 10);
            uartPrint(numberString);
            uartPrint("\n");
            uartPrint("Gimbal Pitch Servo Max:         ");
            itoa((uint16_t) systemConfig.gimbalPitchServoMax, numberString, 10);
            uartPrint(numberString);
            uartPrint("\n");
            uartPrint("Gimbal Pitch Servo Gain:        ");
            ftoa(systemConfig.gimbalPitchServoGain, numberString);
            uartPrint(numberString);
            uartPrint("\n");
        }
        ...
        if (systemConfig.mixerConfiguration == MULTITYPE_BI) {
            ...
            itoa((uint16_t) systemConfig.biLeftServoMin, numberString, 10);
            uartPrint(numberString);
            uartPrint("\n");
            uartPrint("BiCopter Left Servo Mid:        ");
            itoa((uint16_t) systemConfig.biLeftServoMid, numberString, 10);
            uartPrint(numberString);
            uartPrint("\n");
            uartPrint("BiCopter Left Servo Max:        ");
            itoa((uint16_t) systemConfig.biLeftServoMax, numberString, 10);
            uartPrint(numberString);
            uartPrint("\n");
            uartPrint("BiCopter Right Servo Min:       ");
            itoa((uint16_t) systemConfig.biRightServoMin, numberString, 10);
            uartPrint(numberString);
            uartPrint("\n");
            uartPrint("BiCopter Right Servo Mid:       ");
            itoa((uint16_t) systemConfig.biRightServoMid, numberString, 10);
            uartPrint(numberString);
            uartPrint("\n");
            uartPrint("BiCopter Right Servo Max:       ");
            itoa((uint16_t) systemConfig.biRightServoMax, numberString, 10);
            uartPrint(numberString);
            uartPrint("\n");
        }
        ...
        if (systemConfig.mixerConfiguration == MULTITYPE_TRI) {
            ...
            itoa((uint16_t) systemConfig.triYawServoMin, numberString, 10);
            uartPrint(numberString);
            uartPrint("\n");
            uartPrint("TriCopter Yaw Servo Mid:        ");
            itoa((uint16_t) systemConfig.triYawServoMid, numberString, 10);
            uartPrint(numberString);
            uartPrint("\n");
            uartPrint("TriCopter Yaw Servo Max:        ");
            itoa((uint16_t) systemConfig.triYawServoMax, numberString, 10);
            uartPrint(numberString);
            uartPrint("\n");
        }
        ...
        if (systemConfig.mixerConfiguration == MULTITYPE_FLYING_WING) {
            ...
            itoa((uint16_t) systemConfig.rollDirectionLeft, numberString, 10);
            uartPrint(numberString);
            uartPrint("\n");
            uartPrint("Roll Direction Right:           ");
            itoa((uint16_t) systemConfig.rollDirectionRight, numberString, 10);
            uartPrint(numberString);
            uartPrint("\n");
            uartPrint("Pitch Direction Left:           ");
            itoa((uint16_t) systemConfig.pitchDirectionLeft, numberString, 10);
            uartPrint(numberString);
            uartPrint("\n");
            uartPrint("Pitch Direction Right:          ");
            itoa((uint16_t) systemConfig.pitchDirectionRight, numberString, 10);
            uartPrint(numberString);
            uartPrint("\n");
            uartPrint("Wing Left Minimum:              ");
            itoa((uint16_t) systemConfig.wingLeftMinimum, numberString, 10);
            uartPrint(numberString);
            uartPrint("\n");
            uartPrint("Wing Left Maximum:              ");
            itoa((uint16_t) systemConfig.wingLeftMaximum, numberString, 10);
            uartPrint(numberString);
            uartPrint("\n");
            uartPrint("Wing Right Minimum:             ");
            itoa((uint16_t) systemConfig.wingRightMinimum, numberString, 10);
            uartPrint(numberString);
            uartPrint("\n");
            uartPrint("Wing Right Maximum:             ");
            itoa((uint16_t) systemConfig.wingRightMaximum, numberString, 10);
            uartPrint(numberString);
            uartPrint("\n");
        }
    ...
    case 'w':
        ...
        itoa(systemConfig.freeMixMotors, numberString, 10);
        uartPrint(numberString);
        uartPrint("\n\n");
        ...
        for (index = 0; index < systemConfig.freeMixMotors; index++) {
            uartPrint("Motor");
            itoa(index, numberString, 10);
            uartPrint(numberString);
            uartPrint("  ");
            ftoa(systemConfig.freeMix[index][ROLL], numberString);
            uartPrint(numberString);
            uartPrint("  ");
            ftoa(systemConfig.freeMix[index][PITCH], numberString);
            uartPrint(numberString);
            uartPrint("  ");
            ftoa(systemConfig.freeMix[index][YAW], numberString);
            uartPrint(numberString);
            uartPrint("\n");
        }
        queryType = 'x';
