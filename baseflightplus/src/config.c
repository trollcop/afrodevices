...
void checkFirstTime(bool sensorReset, bool systemReset)
{
    ...
    if (systemReset || test_val != checkNewSystemConf) {
        ...
        systemConfig.PID[ROLL_RATE_PID].lastState = 0.0f;
        ...
        systemConfig.PID[PITCH_RATE_PID].lastState = 0.0f;
        ...
        systemConfig.PID[YAW_RATE_PID].lastState = 0.0f;
        ...
        systemConfig.PID[ROLL_ATT_PID].lastState = 0.0f;
        ...
        systemConfig.PID[PITCH_ATT_PID].lastState = 0.0f;
        ...
        systemConfig.PID[HEADING_PID].lastState = 0.0f;
